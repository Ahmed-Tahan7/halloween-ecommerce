...
import { Navbar, Container, Nav } from "react-bootstrap"; // Import necessary components

const TermsOfService = () => {
  return (
    <main className="term-page">
      <section>
        <Navbar className="p-3 term-nav">
          <Container>
      ...
      <section className="term-content">
        <div className="shopify-policy-container">
          <div className="shopify-policy-title">
          ...
          <div class="shopify-policy-body">
            <div>
              ...
              Halloween Template. Throughout the site, the terms “we”, “us” and
              “our” refer to Halloween Template. Halloween Template offers this
              ...
              <br /> By visiting our site and/ or purchasing something from us,
              ...
              of content. <br /> <br /> Please read these Terms of Service
              ...
              acceptance is expressly limited to these Terms of Service. <br />{" "}
              <br /> Any new features or tools which are added to the current
              ...
              constitutes acceptance of those changes. <br /> <br /> Our store
              is hosted on Shopify Inc. They provide us with the online
              e-commerce platform that allows us to sell our products and
              Services to you. <br /> <br />{" "}
              <strong>SECTION 1 - ONLINE STORE TERMS</strong> <br /> By agreeing
              to these Terms of Service, you represent that you are at least the
              ...
              dependents to use this site. <br /> You may not use our products
              for any illegal or unauthorized purpose nor may you, in the use of
              the Service, violate any laws in your jurisdiction (including but
              not limited to copyright laws). <br /> You must not transmit any
              worms or viruses or any code of a destructive nature. <br /> A
              breach or violation of any of the Terms will result in an
              immediate termination of your Services. <br /> <br />{" "}
              <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We reserve
              ...
              transfer over networks. <br /> You agree not to reproduce,
              ...
              without express written permission by us. <br /> The headings used
              ...
              this site is at your own risk. <br /> This site may contain
              ...
              notice at any time. <br /> We shall not be liable to you or to any
              third-party for any modification, price change, suspension or
              discontinuance of the Service. <br /> <br />{" "}
              ...
              according to our Refund Policy: [LINK TO REFUND POLICY] <br /> We
              ...
              will be accurate. <br /> We reserve the right, but are not
              ...
              at anytime without notice, at the sole discretion of us. We
              ...
              the Service will be corrected. <br /> <br />{" "}
              <strong>
              ...
              dealers, resellers or distributors. <br /> <br /> You agree to
              ...
              email address and credit card numbers and expiration dates, so
              that we can complete your transactions and contact you as needed.{" "}
              <br /> <br /> For more details, please review our Refund Policy:
              [LINK TO REFUND POLICY] <br /> <br />{" "}
              <strong>SECTION 7 - OPTIONAL TOOLS</strong> <br /> We may provide
              you with access to third-party tools over which we neither monitor
              nor have any control nor input. <br /> You acknowledge and agree
              ...
              tools. <br /> Any use by you of the optional tools offered through
              the site is entirely at your own risk and discretion and you
              ...
              be subject to these Terms of Service. <br /> <br />{" "}
              <strong>SECTION 8 - THIRD-PARTY LINKS</strong> <br /> Certain
              ...
              Services of third-parties. <br /> We are not liable for any harm
              or damages related to the purchase or use of goods, Services,
              ...
              directed to the third-party. <br /> <br />{" "}
              <strong>
              ...
              or (3) to respond to any comments. <br /> We may, but have no
              ...
              these Terms of Service. <br /> You agree that your comments will
              ...
              after you have submitted your order). <br /> We undertake no
              ...
              <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In addition
              to other prohibitions as set forth in the Terms of Service, you
              ...
              <br /> We do not warrant that the results that may be obtained
              from the use of the Service will be accurate or reliable. <br />{" "}
              You agree that from time to time we may remove the Service for
              indefinite periods of time or cancel the Service at any time,
              without notice to you. <br /> You expressly agree that your use
              ...
              durability, title, and non-infringement. <br /> In no case shall
              Halloween Template, our directors, officers, employees,
              ...
              indemnify, defend and hold harmless Halloween Template and our
              ...
              <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the event
              that any provision of these Terms of Service is determined to be
              ...
              <br /> <br /> <strong>SECTION 16 - TERMINATION</strong> <br /> The
              ...
              for all purposes. <br /> These Terms of Service are effective
              ...
              <br /> If in our sole judgment you fail, or we suspect that you
              ...
              deny you access to our Services (or any part thereof). <br />{" "}
              <br /> <strong>SECTION 17 - ENTIRE AGREEMENT</strong> <br /> The
              failure of us to exercise or enforce any right or provision of
              ...
              <strong>SECTION 18 - GOVERNING LAW</strong> <br /> These Terms of
              Service and any separate agreements whereby we provide you
              Services shall be governed by and construed in accordance with the
              laws of United States. <br /> <br />{" "}
              ...
              <strong>SECTION 20 - CONTACT INFORMATION</strong> <br /> Questions
              about the Terms of Service should be sent to us at
              jasbirosho30@gmail.com. <br /> Our contact information is posted
              below: <br /> [INSERT TRADING NAME] <br /> jasbirosho30@gmail.com{" "}
              <br /> [INSERT BUSINESS ADDRESS] <br /> [INSERT BUSINESS PHONE
              NUMBER] <br /> [INSERT BUSINESS REGISTRATION NUMBER] <br />{" "}
              [INSERT VAT NUMBER]
            </div>
          </div>
        </div>
