...
const TermsOfService = () => {
  return (
    <main className="term-page">
      <section>
        <Navbar className="p-3 term-nav" expand="lg">
          <Container>
            <Nav className="m-auto">
              <Nav.Link className="nav-in" href="#home">
                Home
              </Nav.Link>
              <Nav.Link className="nav-in" href="#terms-of-service">
                Terms of service
              </Nav.Link>
            </Nav>
          </Container>
      ...
      <section className="term-content py-5">
        <Container>
          <Row>
            <Col md={12} lg={10} xl={8} className="mx-auto">
              <div className="shopify-policy-container">
                <div className="shopify-policy-title mb-4">
                  <h1>Terms of service</h1>
                </div>
                <div class="shopify-policy-body">
                  <div>
                    <strong>OVERVIEW</strong> <br /> This website is operated by
                    Halloween Template. Throughout the site, the terms “we”,
                    “us” and “our” refer to Halloween Template. Halloween
                    Template offers this website, including all information,
                    ...
                    content. <br /> <br /> Please read these Terms of Service
                    ...
                    limited to these Terms of Service. <br /> <br /> Any new
                    ...
                    constitutes acceptance of those changes. <br /> <br /> Our
                    store is hosted on Shopify Inc. They provide us with the
                    online e-commerce platform that allows us to sell our
                    products and Services to you. <br /> <br />{" "}
                    <strong>SECTION 1 - ONLINE STORE TERMS</strong> <br /> By
                    agreeing to these Terms of Service, you represent that you
                    are at least the age of majority in your state or province
                    of residence, or that you are the age of majority in your
                    state or province of residence and you have given us your
                    consent to allow any of your minor dependents to use this
                    site. <br /> You may not use our products for any illegal or
                    unauthorized purpose nor may you, in the use of the Service,
                    violate any laws in your jurisdiction (including but not
                    limited to copyright laws). <br /> You must not transmit any
                    worms or viruses or any code of a destructive nature. <br />{" "}
                    A breach or violation of any of the Terms will result in an
                    immediate termination of your Services. <br /> <br />{" "}
                    <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We
                    reserve the right to refuse Service to anyone for any reason
                    at any time. <br /> You understand that your content (not
                    ...
                    networks. <br /> You agree not to reproduce, duplicate,
                    ...
                    notice. <br /> We reserve the right at any time to modify or
                    discontinue the Service (or any part or content thereof)
                    without notice at any time. <br /> We shall not be liable to
                    you or to any third-party for any modification, price
                    change, suspension or discontinuance of the Service. <br />{" "}
                    <br />{" "}
                    <strong>
                      SECTION 5 - PRODUCTS OR SERVICES (if applicable)
                    </strong>{" "}
                    <br /> Certain products or Services may be available
                    exclusively online through the website. These products or
                    Services may have limited quantities and are subject to
                    return or exchange only according to our Refund Policy:
                    [LINK TO REFUND POLICY] <br /> We have made every effort to
                    display as accurately as possible the colors and images of
                    ...
                    prohibited. <br /> We do not warrant that the quality of any
                    products, Services, information, or other material purchased
                    or obtained by you will meet your expectations, or that any
                    errors in the Service will be corrected. <br /> <br />{" "}
                    <strong>
                      SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION
                    </strong>{" "}
                    <br /> We reserve the right to refuse any order you place
                    ...
                    resellers or distributors. <br /> <br /> You agree to
                    provide current, complete and accurate purchase and account
                    information for all purchases made at our store. You agree
                    to promptly update your account and other information,
                    ...
                    <br /> <br /> <strong>SECTION 7 - OPTIONAL TOOLS</strong>{" "}
                    <br /> We may provide you with access to third-party tools
                    over which we neither monitor nor have any control nor
                    input. <br /> You acknowledge and agree that we provide
                    ...
                    third-party tools. <br /> Any use by you of the optional
                    tools offered through the site is entirely at your own risk
                    and discretion and you should ensure that you are familiar
                    with and approve of the terms on which tools are provided by
                    the relevant third-party provider(s). <br /> We may also, in
                    ...
                    of third-parties. <br /> We are not liable for any harm or
                    ...
                    <br /> If, at our request, you send certain specific
                    ...
                    otherwise use in any medium any comments that you forward to
                    us. We are and shall be under no obligation (1) to maintain
                    any comments in confidence; (2) to pay compensation for any
                    comments; or (3) to respond to any comments. <br /> We may,
                    ...
                    intellectual property or these Terms of Service. <br /> You
                    ...
                    <br /> Your submission of personal information through the
                    store is governed by our Privacy Policy, which can be viewed
                    here: [LINK TO PRIVACY POLICY] <br /> <br />{" "}
                    <strong>
                      SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS
                    </strong>{" "}
                    <br /> Occasionally there may be information on our site or
                    ...
                    charges, transit times and availability. We reserve the
                    right to correct any errors, inaccuracies or omissions, and
                    to change or update information or cancel orders if any
                    information in the Service or on any related website is
                    inaccurate at any time without prior notice (including after
                    you have submitted your order). <br /> We undertake no
                    ...
                    No specified update or refresh date applied in the Service
                    or on any related website, should be taken to indicate that
                    all information in the Service or on any related website has
                    been modified or updated. <br /> <br />{" "}
                    <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In
                    ...
                    <br /> We do not guarantee, represent or warrant that your
                    use of our Service will be uninterrupted, timely, secure or
                    error-free. <br /> We do not warrant that the results that
                    may be obtained from the use of the Service will be accurate
                    or reliable. <br /> You agree that from time to time we may
                    remove the Service for indefinite periods of time or cancel
                    the Service at any time, without notice to you. <br /> You
                    expressly agree that your use of, or inability to use, the
                    Service is at your sole risk. The Service and all products
                    and Services delivered to you through the Service are
                    ...
                    <br /> In no case shall Halloween Template, our directors,
                    ...
                    <br /> <br /> <strong>SECTION 14 - INDEMNIFICATION</strong>{" "}
                    <br /> You agree to indemnify, defend and hold harmless
                    Halloween Template and our parent, subsidiaries, affiliates,
                    ...
                    third-party. <br /> <br />{" "}
                    <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the
                    event that any provision of these Terms of Service is
                    ...
                    <br /> <strong>SECTION 16 - TERMINATION</strong> <br /> The
                    obligations and liabilities of the parties incurred prior to
                    the termination date shall survive the termination of this
                    agreement for all purposes. <br /> These Terms of Service
                    ...
                    judgment you fail, or we suspect that you have failed, to
                    comply with any term or provision of these Terms of Service,
                    we also may terminate this agreement at any time without
                    notice and you will remain liable for all amounts due up to
                    and including the date of termination; and/or accordingly
                    may deny you access to our Services (or any part thereof).{" "}
                    <br /> <br /> <strong>SECTION 17 - ENTIRE AGREEMENT</strong>{" "}
                    <br /> The failure of us to exercise or enforce any right or
                    provision of these Terms of Service shall not constitute a
                    waiver of such right or provision. <br /> These Terms of
                    Service and any policies or operating rules posted by us on
                    this site or in respect to the Service constitutes the
                    entire agreement and understanding between you and us and
                    governs your use of the Service, superseding any prior or
                    ...
                    <br /> Any ambiguities in the interpretation of these Terms
                    of Service shall not be construed against the drafting
                    party. <br /> <br />{" "}
                    <strong>SECTION 18 - GOVERNING LAW</strong> <br /> These
                    Terms of Service and any separate agreements whereby we
                    provide you Services shall be governed by and construed in
                    accordance with the laws of United States. <br /> <br />{" "}
                    <strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong>{" "}
                    <br /> You can review the most current version of the Terms
                    of Service at any time at this page. <br /> We reserve the
                    right, at our sole discretion, to update, change or replace
                    any part of these Terms of Service by posting updates and
                    changes to our website. It is your responsibility to check
                    our website periodically for changes. Your continued use of
                    or access to our website or the Service following the
                    ...
                    jasbirosho30@gmail.com. <br /> Our contact information is
                    posted below: <br /> [INSERT TRADING NAME] <br />{" "}
                    jasbirosho30@gmail.com <br /> [INSERT BUSINESS ADDRESS]{" "}
                    <br /> [INSERT BUSINESS PHONE NUMBER] <br /> [INSERT
                    BUSINESS REGISTRATION NUMBER] <br /> [INSERT VAT NUMBER]
                  </div>
                </div>
              </div>
            </Col>
